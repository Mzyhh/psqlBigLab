...
ALTER TABLE IF EXISTS "Items" ADD CONSTRAINT hall_fk FOREIGN KEY (hall_id) REFERENCES "Halls" (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE CASCADE NOT VALID;
...
ALTER TABLE IF EXISTS "PricesXCollections" ADD CONSTRAINT collection_fk FOREIGN KEY (collection_id) REFERENCES "Collections" (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE CASCADE NOT VALID;
